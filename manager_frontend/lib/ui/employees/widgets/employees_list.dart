      ...
      child: SizedBox(
        ...
        child: DataTable(
          ...
          columns: const [
            ...
            DataColumn(label: Text('Phone Number', overflow: TextOverflow.ellipsis)),
            DataColumn(label: Text('Job Title', overflow: TextOverflow.ellipsis)),
            DataColumn(label: Text('Department', overflow: TextOverflow.ellipsis)),
            DataColumn(label: Text('Supervisor', overflow: TextOverflow.ellipsis)),
          ...
          rows: List.generate(20, (index) {
            return DataRow(
              cells: [
                ...
                const DataCell(Text('elgamed@test.com', overflow: TextOverflow.ellipsis)),
                const DataCell(Text('01501106719', overflow: TextOverflow.ellipsis)),
                const DataCell(Text('Developer', overflow: TextOverflow.ellipsis)),
                const DataCell(Text('RnD', overflow: TextOverflow.ellipsis)),
                const DataCell(Text('Himself', overflow: TextOverflow.ellipsis)),
                DataCell(
                  ConstrainedBox(
                    ...
                    child: Row(
                      children: [
                        IconButton(
                          icon:  Icon(Icons.star_border_rounded, color: darkBlue),
